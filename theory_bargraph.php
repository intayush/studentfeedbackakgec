        ...
        <div class="container">
            <div class="container">
                ...
                if (isset($_POST['sub']))
                {
                    ...
                    $year=1;
                    $qryf="SELECT * FROM faculty WHERE id='$faculty_id'";
                    $qry_execute=mysqli_query($con, $qryf);
                    while($fac_data=mysqli_fetch_array($qry_execute)){
                      $faculty_name=$fac_data['name'];
                    }
                    $subject=$_POST['subject'];
                    $qry1="SELECT * FROM theory_response WHERE faculty_id='$faculty_id' AND subject='$subject' AND section='$section'";
                    $result1=mysqli_query($con, $qry1);
      ...
      <table class="striped centered">
        ...
        <tbody>
          <tr>
            ...
            <td><?php echo $total_avg1; ?></td>
            <td><?php echo ($total_avg2 * 100) ."% Yes"; ?></td>
          </tr>
        ...
        <br><br><br>
        <h5>Average Response BarGraph <br>(Question-wise)</h5>
